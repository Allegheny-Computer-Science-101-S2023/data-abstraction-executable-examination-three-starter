...
# The function compute_ratios_while_loop should:
...
# Note that the compute_ratios_while_loop is different that the compute_ratios function
# in question_four.py because this function must use a while loop to produce the answer


def compute_ratios_while_loop(list_one: List[int], list_two: List[int]) -> List[float]:
    """Produce a list of ratios based on the two input lists, using a while loop for the implementation."""
    ratios = []
    maximum_list_size = len(list_one)
    index = 0
    return ratios
...
def question_eight_a():
    ...
    separator = " / "
    question_eight_output_a = str(compute_ratios_while_loop([1, 2, 7, 6], [1, 2, 0, 3]))
    question_eight_output_a = question_eight_output_a + separator + str(compute_ratios_while_loop([0, 0, 0, 0], [1, 2, 4, 3]))
    question_eight_output_a = question_eight_output_a + separator + str(compute_ratios_while_loop([1, 2, 7, 6], [1, 2, 5, 3]))
...
# Function description:
# The function is_factor_echo should:
...
#     and return a tuple containing (input_one, input_two, and a True or False answer)
...
# Note that this function is different than the one in question 4(b) because
# of the fact that it additionally "echos" or returns the input values
# along with also returning the decision about the factor relationship


def is_factor_echo(input_one: int, input_two: int) -> Tuple[int, int, bool]:
...
def question_eight_b():
    ...
    # Do not edit this function
    separator = " / "
    question_eight_output_b = str(is_factor_echo(2, 10))
    question_eight_output_b = question_eight_output_b + separator + str(is_factor_echo(3, 9))
    question_eight_output_b = question_eight_output_b + separator + str(is_factor_echo(3, 10))
    question_eight_output_b = question_eight_output_b + separator + str(is_factor_echo(10, 10))
...
def create_barking_dogs(dog_input_list: List[List[str | int]]) -> str:
    ...
    for current_input_dog_list in dog_input_list:
        ...
        current_dog_barking_output = current_dog.bark(str(current_input_dog_list[0]))
